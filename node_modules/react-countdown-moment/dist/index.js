  ...
  var CountdownText = (function(_Component) {
    ...
    function CountdownText(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (CountdownText.__proto__ || Object.getPrototypeOf(CountdownText)).call(
          this
        )
      );
    ...
    _createClass(CountdownText, [
      ...
      },
      {
        ...
        value: function tick() {
          ...
          var countdown =
            (0, _leftPad2.default)(dur.months(), 2, 0) +
            ":" +
            (0, _leftPad2.default)(dur.days(), 2, 0) +
            ":" +
            (0, _leftPad2.default)(dur.hours(), 2, 0) +
            ":" +
            (0, _leftPad2.default)(dur.minutes(), 2, 0) +
            ":" +
            (0, _leftPad2.default)(dur.seconds(), 2, 0);
